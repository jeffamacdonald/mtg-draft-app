class DraftsController < ApplicationController
  ...
  def show
    ...
    @context = MagicCardContext.for_active_draft(draft: @draft, draft_participant: @draft.draft_participants.find_by(user: current_user), text_only: filter_params[:text_only] == "1", image_size: filter_params[:image_size])
  end
